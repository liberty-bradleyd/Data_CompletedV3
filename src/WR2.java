	...
	private void initialize() {
		...
		// Add a scroll pane, so that our list box can be scrolled.
		 ...
		 // Add a Panel to display the observation for a selected station.
			...
			lblTempText.setFont(new Font("Tahoma", Font.BOLD, 35));
			...
			lblWeatherText.setFont(new Font("Tahoma", Font.BOLD, 35));
			...
			lblWeatherData.setFont(new Font("Tahoma", Font.PLAIN, 35));
			...
			lblTempData.setFont(new Font("Tahoma", Font.PLAIN, 35));
			...
			lblWindConditionsText.setFont(new Font("Tahoma", Font.BOLD, 35));
			...
			lblWindText.setFont(new Font("Tahoma", Font.BOLD, 35));
			...
			lblBarometricPressure.setFont(new Font("Tahoma", Font.BOLD, 35));
			...
			lblWindData.setFont(new Font("Tahoma", Font.PLAIN, 35));
			...
			lblWindConditionsData.setFont(new Font("Tahoma", Font.PLAIN, 35));
			...
			lblPressureData.setFont(new Font("Tahoma", Font.PLAIN, 35));
			...
			lblHumidity.setFont(new Font("Tahoma", Font.BOLD, 35));
			...
			lblHumidityData.setFont(new Font("Tahoma", Font.PLAIN, 35));
